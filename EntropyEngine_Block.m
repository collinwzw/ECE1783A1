classdef EntropyEngine_Block
   properties (GetAccess='public', SetAccess='public')
    ...
    methods(Access = 'public')
        function obj = EntropyEngine_Block(B,rowQP,RCflag)
            obj.RCflag = RCflag;
            if obj.RCflag == 0
                obj = EntropyEngineRCflagOFF(obj,B);
            else
                obj = EntropyEngineRCflagON(obj,B,rowQP);
            end
%             obj.B=B;
%             obj.rowQP = rowQP;
%             obj.splitindex=0;
...
%             obj.bitstream = [obj.bitstream obj.encodeExpGolomblist(encodedReorderedList)];
        ...
        function obj = EntropyEngineRCflagOFF(obj,B)
            obj.B=B;
        ...
        function obj = EntropyEngineRCflagON(obj,B,rowQP)
            obj.B=B;
            obj.rowQP = rowQP;
            obj.splitindex=0;
