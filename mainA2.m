...
if parallelMode==0
    ...
    if RCflag >= 2
        ...
        fprintf(" starting normal encoding \n" );
        e = Encoder_parallel(v1WithPadding,block_width, block_height,r , QP, I_Period,nRefFrame, FEMEnable, FastME, VBSEnable,RCflag, bitBudget, ParallelMode,parallelMode);
    end
end
%%
